...
import pe.edu.upeu.syscenterlife.modelo.dao.ResultadoDAO;
import java.util.ArrayList;
import javax.swing.JButton;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;

public class TresEnRayaGui1 extends javax.swing.JFrame {
    ...
    public void ListarTodos() {
        ...
        ArrayList<Resultado> lista = resultadoDao.Listar();
    ...
    public void QuienJuega() {
        if (turno % 2 != 0) {
            txtTurnoJugador.setText(txtJugador1.getText()+" (0) ");
        } else {
            txtTurnoJugador.setText(txtJugador2.getText()+" (X) ");
        }
    }
    ...
    public void ActualizarGanador(String ganador, int puntuacion, String estado) {
        if (obj != null) {
            ...
            int result = resultadoDao.Actualizar(obj);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Mark Emerson Mercado Huaracha ");

        jLabel5.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        jLabel5.setText("Juego tres en raya ");
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        obj.setNombrePartida("Partida " + resultadoDao.MaximaPartida());

        int result = resultadoDao.Insertar(obj);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TresEnRayaGui1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TresEnRayaGui1().setVisible(true);
            }
        });
    }
